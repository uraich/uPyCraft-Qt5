...
class myTerminal(QTextEdit):
    ...
    def mousePressEvent(self,event):
        ...
        if event.button()==Qt.RightButton:
            print("Right button seen")
            self.sig_customContextMenuRequested.emit(event.pos())
...
class myTreeView(QTreeView):
    ...
    def createRightMenu(self):
        ...
        print("Connecting to slotRightClickMenu")
    ...
    def chooseFile(self,index):
        ...
        if dirList[1]=="device":
            ...
            if self.ui.createWorkSpacePath():
                ...
                self.ui.fileName=""
            print("Workspace seen, self.ui.filename: %s"%self.ui.fileName)
        else:
            pass
...
class myTabWidget(QTabWidget):
    ...
    def slotEditorRightClickMenu(self,point):
        print("slotEditorRightclickMenu")
